...
#define DEBUG_AREAS							0 | TEMP2_DEBUG_AREA //| TRAIN_SRV_DEBUG_AREA // | TRAIN_NOTIFIERS_DEBUG_AREA  // TRAIN_MGR_DEBUG_AREA | TRAIN_SRV_DEBUG_AREA //COMMAND_SERVER_DEBUG_AREA | KERNEL_DEBUG_AREA
...
#define COMMAND_SERVER_PRIORITY				12			// CMD SERVER
#define COMMAND_NOTIFIER_PRIORITY			13
